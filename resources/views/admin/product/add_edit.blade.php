                            ...
                            <div class="row">
                                <div class="col-md-6">
                                   ...
                                   {{-- <div id="appendCategoryLevel">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_code" id="productCode" placeholder="Enter Product Code"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_color" id="productColor" placeholder="Enter Product Color"
                                            {{-- @if(!empty($categoryData['category_discount']))
                                             value="{{ $categoryData['category_discount'] }}"
                                             @else
                                             value="{{ old('category_discount') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_discount" id="productDiscount" placeholder="Enter Product Discount"
                                            {{-- @if(!empty($categoryData['category_discount']))
                                             value="{{ $categoryData['category_discount'] }}"
                                             @else
                                             value="{{ old('category_discount') }}"
                                    ...
                                    <div class="form-group">
                                        <label for="productWeight">Product Discount</label>
                                        <input type="text" class="form-control" name="product_weight" id="productWeight" placeholder="Enter Product Weight"
                                            {{-- @if(!empty($categoryData['category_discount']))
                                             value="{{ $categoryData['category_discount'] }}"
                                             @else
                                             value="{{ old('category_discount') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="product_description" id="productDescription" placeholder="Enter Product Description"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <div class="custom-file">
                                                <input type="file" name="main_image" class="custom-file-input" id="mainImage" accept="image/*" onchange="loadFile(event)">
